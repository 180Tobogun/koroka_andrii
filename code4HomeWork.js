...
// 4)Дан массив [1, 2, 3, 4, 5].С помощью метода splice сделайте из него массив
//     [1, 2, 3, 'a', 'b', 'c', 4, 5].
...
//
// const product = +prompt('сколько товаров в корзине?');
// const product1 = product % 100;
// const product2 = product1 % 10;
// if (product1 > 10 && product2 < 20) {
//     alert(`в корзине ${product} товаров`)
//
// } else if (product2 >= 2 && product2 < 5) {
//     alert(`в корзине ${product} товара`)
//
// } else if (product2 === 1) {
//     alert(`в корзине ${product} товар`)
//
// } else {
//     alert(`в корзине ${product} товаров`)
// }
